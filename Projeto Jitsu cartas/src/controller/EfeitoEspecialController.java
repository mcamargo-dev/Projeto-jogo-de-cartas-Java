...
public class EfeitoEspecialController {
    ...
    public EfeitoEspecialController(EfeitoEspecialView view) {
        this.view = view;
        // Carga inicial Mock para testes rápidos
        bancoDadosEfeitos.add(new EfeitoEspecial(geradorId++, "Bloqueio de Fogo", "Impede o oponente de jogar cartas de fogo na próxima rodada", gerais.enums.TipoEfeito.BLOQUEAR_ELEMENTO));
    }
